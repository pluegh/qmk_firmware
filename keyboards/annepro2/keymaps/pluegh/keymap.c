...
* |-----------------------------------------------------------------------------------------+
* |FN1/grv|  Alt  |  L1   |               space             |  L2   |  Alt  |  FN2  | FN1   |
* \-----------------------------------------------------------------------------------------/
...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    MT(MOD_LSFT,KC_GRAVE), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_UP),
    LT(_FN1_LAYER,KC_CAPS), KC_LALT, KC_LGUI, KC_SPC, KC_RGUI, MT(MOD_RALT,KC_LEFT), LT(_FN2_LAYER,KC_DOWN), LT(_FN1_LAYER,KC_RGHT)
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Tab    |  F9 | F10 | F11 | F12 |  t  |  y  |  u  |  i  |  o  | PS |  up  | END |   \    |
  * |-----------------------------------------------------------------------------------------+
  * | Esc     | F5  | F6  |  F7 |  F8 |  g  |  h  |  j  |  k  |  l  | lft |rght |    Enter    |
  * |-----------------------------------------------------------------------------------------+
  * |            |  F1 |  F2 |  F3 |  F4 |  b  |  n  |  m  |  ,  |INSRT| dwn |                |
  * |-----------------------------------------------------------------------------------------+
  * |       |       |       |               space             |       |       |       |       |
  * \-----------------------------------------------------------------------------------------/
  *
 ...
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_UP, KC_END, KC_TRNS,
    KC_TRNS, KC_F5, KC_F6, KC_F7, KC_F8, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_RGHT, KC_TRNS,
    KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS, KC_DOWN, KC_TRNS,
